  ...
  data() {
    ...
    return {
      ...
      Topspeed: [
        {
          title: "选择心仪的定期产品",
          explain: '新手体验只限使用体验金购买哦',
          src: require("../assets/step1&45a7ffae.jpg")
        },
        {
          title: "查看产品详情",
          explain: '浏览产品信息，点击"立即体验"',
          src: require("../assets/step2&e3079541.jpg")
        },
        {
          title: "填写购买表单",
          explain: "第一次使用可享受您的体验金哦～",
          src: require("../assets/step3&b7ee2637.jpg")
        },
        {
          title: "输入交易密码",
          explain: "输入此前设置的交易密码",
          src: require("../assets/step4&38de3388.jpg")
        },
         {
          title: "定期产品购买成功",
          explain: "",
          src: require("../assets/step5&f3253151.jpg")
        },
          {
          title: "",
          explain: "",
          src: require("../assets/end&3120b651.jpg")
        }
      ]
    };
  },
